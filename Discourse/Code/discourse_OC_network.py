...
def main(graph): 
	...
	allPosts = {} # start by building a map of posts-to-authors based on post_id
	words = 0
	checklistPosts = [] 
	# just in case the APIs return duplicates
	# the following is to keep track of the comments by Noemi, Nadia and Alberto
	teamPosts = {'noemi': 0, 'nadia': 0, 'alberto': 0}
	checklistTeam = []   
	topics = discourse_API_Edgeryders.fetch_topics_from_tag('citizen-science') # to replace with project-opencare
